...
struct HomeView: View {
    ...
    var body: some View {
        NavigationView {
            ...
            .onAppear {
                // Phase 5: run the one-time mastery recompute then show the reassessment screen.
                // recomputeFromHistory() is idempotent — it checks its own UserDefaults guard.
            ...
            VStack(alignment: .leading, spacing: 14) {
                HStack(spacing: 12) {
                    ...
                    VStack(alignment: .leading, spacing: 4) {
                        ...
                        Text("Track \(dataService.userProgress.currentDay) of \(TrainingConstants.totalTracks)")
                            .font(.subheadline)
                            .foregroundColor(AppColors.textMuted)
                    }
                ...
                ProgressBarView(
                    ...
                    total: TrainingConstants.totalTracks,
...
struct ProgressStatsCard: View {
    ...
    var completedTracks: Int {
        dataService.getAllCompletedTracks().count
    }
    ...
    var body: some View {
        Button {
            ...
            VStack(alignment: .leading, spacing: 14) {
                ...
                HStack(spacing: 0) {
                    StatPill(value: "\(completedTracks)", label: "Tracks", icon: "checkmark.circle")
