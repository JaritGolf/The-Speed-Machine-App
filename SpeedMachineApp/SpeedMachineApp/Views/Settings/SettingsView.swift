            ...
            ZStack {
                ...
                List {
                    ...
                    Section {
                        ...
                        Text("Choose the color theme for all active session screens. Dark is recommended for the 5–6 ft viewing distance.")
                    }
                    ...
                    Section {
                        HStack {
                            Text("Program Sync")
                            Spacer()
                            Text(UserDefaults.standard.string(forKey: NetworkService.statusKey) ?? "Not started")
                        ...
                        Text("Shows whether the app successfully fetched the latest training program from the server.")
                    }
